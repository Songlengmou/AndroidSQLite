...
public class EditUserActivity extends AppCompatActivity implements View.OnClickListener {
    /**
     * 因为数据库中的_id自增列的值不可能为0，它是从1开始自增的，所以如果获取到的_id值是0
     * ，则代表外界并没有传入_id的值，外界可认定为是新增，而不是修改
     */
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.btnSave:
                ...
                data.putExtra(KEY_USER_ID, getIntent().getIntExtra(KEY_USER_ID, USER_ID_DEFAULT_VALUE));//修改时所用
